/**** C/C++ constants and function definitions for LL31.DLL ****/
/****  (c) combit GmbH ****/
/****  [build of 2025-02-05 10:02:03] ****/

#ifndef _LL31_H /* include header only once */
#define _LL31_H

#if !defined(_LL31_DONT_INCLUDE_OLE2_H) && !defined(_RC_INVOKED_) && !defined(RC_INVOKED)
  #if defined(WIN32)
    #include <ole2.h>
  #endif
#endif
...
#define LL_INPUTOBJECT_EDIT            (0x00200000          )
#define LL_INPUTOBJECT_CHECKBOX        (0x00200001          )
#define LL_INPUTOBJECT_COMBOBOX        (0x00200002          )
#define LL_INPUTOBJECT_BUTTON          (0x00200003          )
#define LL_INPUTOBJECT_RADIOGROUP      (0x00200004          )
#define LL_INPUTOBJECT_LISTBOX         (0x00200005          )
#define LL_INPUTOBJECT_TYPEMASK        (0x000000ff          )
...
#define LL_OPTION_COMPAT_ALLOW_BASELEVEL_CROSSTABS (420                 ) /* default: false */
#define LL_OPTION_AUTODEFINE_PATCH     (421                 ) /* default: 0 */
#define LL_OPTION_BASE64TEMPFILECACHESIZE (422                 ) /* default: 200 */
#define LL_OPTION_COMPAT_ZUGFERDXMLPATH_PREVIEWEMBEDDING (423                 ) /* default: false */
#define LL_OPTION_SUPPRESS_LOADERRORMESSAGES_WRITELOG (424                 ) /* default: 0 */
#define LL_OPTION_CHARTLEGEND_ALLOWMIXEDLINETYPESYMBOLS (425                 ) /* default: false */
#define LL_OPTION_USEDIDENTIFIERS_SCANFORFILENAMES (426                 ) /* default: false */
#define LL_OPTION_ALLOW_TIME_IN_REPORTPARAMETER (427                 ) /* default: false  */
#define LL_OPTION_COMPAT_NUMERIC_SIGN_ONLY_IS_ZERO (428                 ) /* default: false */
#define LL_OPTION_PROHIBIT_DESIGNER_CACHING_TEXTOBJECTS (429                 ) /* default: false */
...
#  endif
 ...
 typedef struct
  ...
  HANDLE  _hContents;
  VARIANT* _pvContents;
   BOOL        _isReallyNullForInternalUse;
  } scLlDelayedValue2W;
...
CMBT_LL_WINAPI FARPROC  DLLPROC  LlSetNotificationCallback
...
#if defined(WIN32) && !defined(_NO_CMLL31APIDEFINES)
   #ifdef UNICODE
   ...
   #endif // UNICODE
#endif // WIN32, _NO_CMLL31APIDEFINES
#ifdef WIN32
...
CMBT_LL_WINAPI INT      DLLPROC  LlTokenProviderAdd
	(
	HLLJOB               hJob,
	LPCWSTR              id,
	PIUNKNOWN            ppI
...
CMBT_LL_WINAPI INT      DLLPROC  LlTokenProviderRemove
	(
	HLLJOB               hJob,
	LPCWSTR              id
	);

CMBT_LL_WINAPI INT      DLLPROC  LlGetAvailableTimeZones
	(
	PVARIANT             pvArray
	);

CMBT_LL_WINAPI INT      DLLPROC  LlGetAvailableFonts
	(
	HLLJOB               hJob,
	PVARIANT             pvArray
	);

CMBT_LL_WINAPI INT      DLLPROC  LlRepositoryGetDrilldownItemList
	(
	HLLJOB               hLlJob,
	LPCWSTR              pszRootTableID,
	LPCWSTR              pszProjectType,
	UINT32               nDrilldownType,
	PVARIANT             pvArray
	);

CMBT_LL_WINAPI INT      DLLPROC  LlUtilsGetReportParameterNames
	(
	HLLJOB               hJob,
	LPCWSTR              pszProjectFilename,
	PVARIANT             pvArray
...
CMBT_LL_WINAPI INT      DLLPROC  LlGetIdentifierHelpText
	(
	HLLJOB               hJob,
	LPCWSTR              pszVarName,
	LPWSTR               pszBuffer,
...
CMBT_LL_WINAPI HLLEXPR  DLLPROC  LlExprParseEx2
	(
	HLLJOB               hLlJob,
	LPCWSTR              lpExprText,
	UINT                 nParaTypes,
