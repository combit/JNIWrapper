/**** C/C++ constants and function definitions for LL27.DLL ****/
/****  (c) combit GmbH ****/
/****  [build of 2021-03-02 09:03:49] ****/

#ifndef _LL27_H /* include header only once */
#define _LL27_H

#if !defined(_LL27_DONT_INCLUDE_OLE2_H) && !defined(_RC_INVOKED_) && !defined(RC_INVOKED)
  #if defined(WIN32)
    #include <ole2.h>
  #endif
#endif
...
#define LL_PRNOPTSTR_NEXT_INDEX        (13                  )
...
CMBT_LL_WINAPI FARPROC  DLLPROC  LlSetNotificationCallback
...
#if defined(WIN32) && !defined(_NO_CMLL27APIDEFINES)
   #ifdef UNICODE
   ...
   #endif // UNICODE
#endif // WIN32, _NO_CMLL27APIDEFINES
#ifdef WIN32
