/**** C/C++ constants and function definitions for LL26.DLL ****/
/****  (c) combit GmbH ****/
/****  [build of 2020-02-28 02:02:07] ****/

#ifndef _LL26_H /* include header only once */
#define _LL26_H

#if !defined(_LL26_DONT_INCLUDE_OLE2_H) && !defined(_RC_INVOKED_) && !defined(RC_INVOKED)
  #if defined(WIN32)
    #include <ole2.h>
  #endif
#endif
...
CMBT_LL_WINAPI FARPROC  DLLPROC  LlSetNotificationCallback
...
#if defined(WIN32) && !defined(_NO_CMLL26APIDEFINES)
   #ifdef UNICODE
   ...
   #endif // UNICODE
#endif // WIN32, _NO_CMLL26APIDEFINES
#ifdef WIN32
