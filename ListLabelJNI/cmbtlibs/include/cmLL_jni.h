...
JNIEXPORT jint JNICALL FCT(_LlDomGetProject)(JNIEnv*, jobject, jint, jPHLLDOMOBJ);
...
JNIEXPORT jint JNICALL FCT(_LlDomGetObject)(JNIEnv*, jobject, jHLLDOMOBJ, jstring, jPHLLDOMOBJ);
JNIEXPORT jint JNICALL FCT(_LlDomGetSubobjectCount)(JNIEnv*, jobject, jHLLDOMOBJ, j_LPINTJAVADUMMY);
JNIEXPORT jint JNICALL FCT(_LlDomGetSubobject)(JNIEnv*, jobject, jHLLDOMOBJ, jint, jPHLLDOMOBJ);
JNIEXPORT jint JNICALL FCT(_LlDomCreateSubobject)(JNIEnv*, jobject, jHLLDOMOBJ, jint, jstring, jPHLLDOMOBJ);
