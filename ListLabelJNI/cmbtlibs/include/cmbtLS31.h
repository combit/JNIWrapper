/**** C/C++ constants and function definitions for LS31.DLL ****/
/****  (c) combit GmbH ****/
/****  [build of 2025-02-05 06:02:36] ****/

#ifndef _LS31_H /* include header only once */
#define _LS31_H

#if !defined(_LS31_DONT_INCLUDE_OLE2_H) && !defined(_RC_INVOKED_) && !defined(RC_INVOKED)
  #if defined(WIN32)
    #include <ole2.h>
  #endif
#endif
...
#ifndef PCLOGFONT
  #define PCLOGFONT                      const LOGFONT FAR *
#endif

#ifndef PILsConvertImageStreamEMF
  #define PILsConvertImageStreamEMF      ILsConvertImageStreamEMF FAR *
#endif
...
#define LS_VIEWERCONTROL_QUEST_IENUM_AUTHTOKENPROVIDER (39                  )
...
#  endif
 ...
 interface ILsConvertImageStreamEMF
  {
   STDMETHOD(onEMFRecord)(const ENHMETARECORD* pEMR) = 0; // return E_ABORT for abort
  };
...
extern "C"
{
...
#if defined(WIN32) && !defined(_NO_CMLS31APIDEFINES)
   #ifdef UNICODE
   ...
   #endif // UNICODE
#endif // WIN32, _NO_CMLS31APIDEFINES
#ifdef WIN32
...
#ifdef WIN32
CMBT_LS_WINAPI INT      DLLPROC  LsMailAuthTokenProviderAdd
	(
	HLSMAILJOB           hJob,
	LPCWSTR              id,
	PIUNKNOWN            ppI
...
#ifdef WIN32
CMBT_LS_WINAPI INT      DLLPROC  LsMailAuthTokenProviderRemove
	(
	HLSMAILJOB           hJob,
	LPCWSTR              id
	);
...
#ifdef WIN32
CMBT_LS_WINAPI INT      DLLPROC  LsFontEmbeddingAddFromStream
	(
	LPCWSTR              pszFaceName,
	INT                  nFontType,
	LPCWSTR              pszData
...
#ifdef WIN32
CMBT_LS_WINAPI INT      DLLPROC  LsFontEmbeddingAddFromLogfont
	(
	LPCWSTR              pszFaceName,
	INT                  nFontType,
	PCLOGFONT            pLogfont
...
#ifdef WIN32
CMBT_LS_WINAPI INT      DLLPROC  LsFontEmbeddingRemove
	(
	LPCWSTR              pszFaceName,
	INT                  nFontType
	);
...
#ifdef WIN32
CMBT_LS_WINAPI INT      DLLPROC  LsFontEmbeddingGetStream
	(
	LPCWSTR              pszFaceName,
	INT                  nFontType,
	PBSTR                pbsData
...
#ifdef WIN32
CMBT_LS_WINAPI INT      DLLPROC  LsFontEmbeddingGetFontStream
	(
	LPCWSTR              pszFaceName,
	INT                  nFontType,
	PSTREAM              pStream,
...
#ifdef WIN32
CMBT_LS_WINAPI INT      DLLPROC  LsConvertImageStreamEx
	(
	LPVOID               pGDICommentData,
	PHGLOBAL             hGlobal,
	PILsConvertImageStreamEMF                     pCallbackForEMFRecords,
	UINT                 nOptions
	);
#endif // WIN32
