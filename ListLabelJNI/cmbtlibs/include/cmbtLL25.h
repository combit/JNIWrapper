/**** C/C++ constants and function definitions for LL25.DLL ****/
/****  (c) combit GmbH ****/
/****  [build of 2019-07-02 08:07:35] ****/

#ifndef _LL25_H /* include header only once */
#define _LL25_H

#if !defined(_LL25_DONT_INCLUDE_OLE2_H) && !defined(_RC_INVOKED_) && !defined(RC_INVOKED)
  #if defined(WIN32)
    #include <ole2.h>
  #endif
#endif
...
#define LL_OPTION_PDFBOOKMARKS_SUPPRESS_PAGERESET (352                 ) /* default: false */
...
#  endif
 ...
 interface DECLSPEC_UUID("EC59A020-8D18-4A26-8E6C-ED136A3DC5D3") ILLRepositoryItem
  : public IUnknown
  {
 ...
 interface DECLSPEC_UUID("10AA56A0-E632-44DC-94A3-40664633930B") ILLRepositoryItemSink
  : public IUnknown
  {
   STDMETHOD(DefineItem)(LPCWSTR psID, LPCWSTR psItemBLOB) PURE;
  };
 
 interface DECLSPEC_UUID("8C348041-4E51-4FDF-A79C-376BC8C0234F") ILLRepository
  : public IUnknown
  {
   STDMETHOD(DefineItems)(ILLDebugSink* pDebugSink, ILLRepositoryItemSink* pSink) PURE;
   ...
   LL_ENUM_DEF enInfoType
    {
    INFO_TIMESTAMP = 1, // VT_DATE
    INFO_READONLY = 2, // VT_BOOL
    INFO_BLOB = 3, // VT_BSTR
    INFO_QUERY_THREADED_ACCESS = 4, // VT_BOOL, psID == NULL. Default (on failure of call) is TRUE
    };
...
CMBT_LL_WINAPI FARPROC  DLLPROC  LlSetNotificationCallback
...
#if defined(WIN32) && !defined(_NO_CMLL25APIDEFINES)
   #ifdef UNICODE
   ...
   #endif // UNICODE
#endif // WIN32, _NO_CMLL25APIDEFINES
#ifdef WIN32
